...
rotas.post("/produto", multer.single('produto_imagem'), validarRequisicao(validacaoProduto), produtos.cadastrarProduto);
rotas.put("/produto/:id", multer.single('produto_imagem'), validarRequisicao(validacaoProduto), produtos.editarProduto);
